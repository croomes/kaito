...
func TestAddOrUpdateInferenceSet_PropagatesCacheToWorkspace(t *testing.T) {
	...
	mockClient.On("Get", mock.Anything, mock.Anything, mock.IsType(&v1alpha1.InferenceSet{}), mock.Anything).Return(nil)
	mockClient.StatusMock.On("Update", mock.Anything, mock.IsType(&v1alpha1.InferenceSet{}), mock.Anything).Return(nil)
